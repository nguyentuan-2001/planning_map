...
},{}],"Scripts/Layer.js":[function(require,module,exports) {
"use strict";
...
$("#layers").click(function () {
  ...
  layers.forEach(function (layer) {
    ...
    if (layerName !== undefined) {
      var element = "<div class=\"form-check\" >\n        <input class=\"form-check-input\" type=\"checkbox\" value=\"\" id=".concat(layerName, ">\n        <label class=\"form-check-label\" for=\"flexCheckDefault\">\n          ").concat(layerName, "\n        </label>\n      </div>");
      layersDivContent.append(element);
      $("#".concat(layerName)).prop("checked", layer.getVisible());
    }
  });
  $(".form-check-input").change(function () {
    var checkbox = this;
    var layerName = checkbox.id;
    var layer = (0, _customFunctions.getLayerByname)(layerName);
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","Scripts/Layer.js"], null)
//# sourceMappingURL=/Layer.9f5105a2.js.map